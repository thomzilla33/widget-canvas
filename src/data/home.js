...
export const GOV_EVENTS = [
  {
    ...
    impact: {
      workflows: 14,
      agents: 3,
      flowNames: ['DIAN Intake Process', 'Revenue Forecast'],
      flowList: [
        { name: 'Acme Corp onboarding',     tag: 'Customer',   urgent: 'SLA breach in 47m'      },
        { name: 'Revenue close process',    tag: 'Finance',    urgent: '$84k invoice pending'    },
        { name: 'DIAN Intake Process',      tag: 'Compliance', urgent: null                      },
        { name: 'Tax Compliance v2',        tag: 'Internal',   urgent: null                      },
        { name: 'Quarterly Reconciliation', tag: 'Finance',    urgent: null                      },
        { name: 'CS Health sync',           tag: 'Internal',   urgent: null                      },
        { name: 'Acme Corp renewal flow',   tag: 'Customer',   urgent: null                      },
        { name: 'Partner onboarding v3',    tag: 'Customer',   urgent: null                      },
        { name: 'NPS Survey distribution',  tag: 'Internal',   urgent: null                      },
        { name: 'Budget approval chain',    tag: 'Finance',    urgent: null                      },
        { name: 'Employee expense sync',    tag: 'Internal',   urgent: null                      },
        { name: 'Data retention audit',     tag: 'Compliance', urgent: null                      },
        { name: 'Vendor contract renewal',  tag: 'Finance',    urgent: null                      },
        { name: 'Offboarding checklist',    tag: 'Internal',   urgent: null                      },
      ],
      agentNames: ['SalesForecastPA', 'TaxBot', 'CompliancePA'],
      blockedSince: '2h 12m',
      customerFacing: 3,
      slaBreachIn: '47m',
    },
  ...
  },
  {
    ...
    impact: {
      workflows: 8,
      agents: 2,
      flowNames: ['Sales Outreach Sequence', 'Pipeline Forecast'],
      agentNames: ['SalesForecastPA', 'SequenceBot'],
      blockedSince: '23m',
    },
    action: 'Allow send',
    when: '23m ago',
  },
  {
    ...
    impact: {
      workflows: 5,
      agents: 1,
      flowNames: ['Finance Close', 'AP Aging Report'],
      agentNames: ['FinancePA'],
      blockedSince: '47m',
    },
    action: 'Approve',
    when: '47m ago',
