...
export const notifications = [
  {
    ...
    desc: 'Dana Lee escalated “Outreach Agent” run #1,284. Decision needed before SLA expires.',
    time: '2m ago', day: 'today', unread: true, assignedToMe: true,
    ctas: ['Review', 'Delegate'],
  },
  {
    id: 'n2', source: 'agent', eventType: 'failure', severity: 'critical',
    title: 'Agent halted — 3 consecutive failures',
    desc: '”Contact Enrichment” stopped. Last error: API rate limit exceeded.',
    time: '18m ago', day: 'today', unread: true,
    ctas: ['View trace', 'Retry'],
  },
  {
    id: 'n3', source: 'system', eventType: 'update', severity: 'warning',
    title: 'Freshness threshold exceeded',
    desc: '”NPS Trend” widget is stale — last synced 3 days ago.',
    time: '1h ago', day: 'today', unread: true,
    ctas: ['Remap widget'],
  },
  {
    id: 'n8', source: 'human', eventType: 'reminder', severity: 'warning',
    title: 'Decision due in 2h — Outreach campaign approval',
    desc: 'SLA window closes at 5:00 PM. “Q3 Outreach” campaign is paused until you approve.',
    time: '2h ago', day: 'today', unread: true, assignedToMe: true,
    ctas: ['Approve', 'Reject'],
  },
  {
    id: 'n4', source: 'workflow', eventType: 'completion', severity: 'success',
    title: 'Weekly sync complete',
    desc: '”Salesforce Contact Sync” finished. 2,140 records updated, 0 errors.',
    time: '3h ago', day: 'today', unread: false,
    ctas: ['View report'],
  },
  {
    id: 'n9', source: 'workflow', eventType: 'completion', severity: 'success',
    title: 'Quarterly exec report auto-generated',
    desc: '47 pages, 12 charts, 0 errors. Ready for review before Monday\'s board meeting.',
    time: '4h ago', day: 'today', unread: false,
    ctas: ['View report'],
  },
  {
    id: 'n5', source: 'integration', eventType: 'security', severity: 'critical',
    title: 'API credential expiring soon',
    desc: 'Zendesk integration token expires in 48h. Rotate before dashboards go stale.',
    time: 'Yesterday', day: 'yesterday', unread: true, assignedToMe: true,
    ctas: ['Rotate token'],
  },
  {
    id: 'n10', source: 'agent', eventType: 'failure', severity: 'critical',
    title: 'Lead Enrichment agent paused — daily quota exceeded',
    desc: 'Clearbit quota hit at 4,000 lookups. Agent will resume tomorrow at midnight.',
    time: 'Yesterday', day: 'yesterday', unread: true,
    ctas: ['View run'],
  },
  {
    id: 'n6', source: 'workflow', eventType: 'update', severity: 'info',
    title: '3 dashboards you follow were updated',
    desc: 'Sales — Account 360, Manager Overview, +1 more.',
    time: 'Yesterday', day: 'yesterday', unread: false,
    ctas: ['View dashboards'],
  },
  {
    id: 'n11', source: 'integration', eventType: 'completion', severity: 'success',
    title: 'Salesforce re-sync completed after credential rotation',
    desc: '61,200 records refreshed. All dependent widgets are back to live.',
    time: 'Yesterday', day: 'yesterday', unread: false,
    ctas: [],
  },
  {
    id: 'n7', source: 'human', eventType: 'assignment', severity: 'info',
    title: 'Flag resolved',
    desc: '”Open Tickets — Wrong records shown” was marked resolved by James Ortega.',
    time: '2 days ago', day: 'earlier', unread: false,
    ctas: [],
  },
  {
    id: 'n12', source: 'system', eventType: 'security', severity: 'critical',
    title: 'Unusual login detected from a new IP',
    desc: 'Sign-in from 185.220.101.x (Tor exit node) was blocked by your org policy.',
    time: '3 days ago', day: 'earlier', unread: false,
    ctas: ['Review sessions'],
  },
  {
    id: 'n13', source: 'workflow', eventType: 'completion', severity: 'info',
    title: 'Weekly dashboard digest published',
    desc: '12 active dashboards, 480 widget views, 3 dashboards need attention.',
    time: '4 days ago', day: 'earlier', unread: false,
    ctas: ['View digest'],
  },
  {
    id: 'n14', source: 'human', eventType: 'assignment', severity: 'info',
    title: 'Assigned to you: Review credit export report',
    desc: 'Priya Nair assigned the Q2 credit report export for compliance sign-off.',
    time: '5 days ago', day: 'earlier', unread: false, assignedToMe: true,
    ctas: ['Open task'],
  },
  {
    id: 'n15', source: 'agent', eventType: 'completion', severity: 'success',
    title: '5 agents ran overnight with no issues',
    desc: 'Nightly batch complete: Contact Sync, Lead Score, Churn Monitor, Invoice Check, NPS Pull.',
