...
export const dashboards = [
  { id: 'd-aims-ops', template: 't-aims-ops', name: 'AIMS Operations', description: 'Tracks agent and workflow activity across all active automations in this workspace.', entity: 'Report', audience: 'Manager', owner: 'Priya Nair', status: 'published', widgets: 7, updated: '1 hour ago', placement: { surface: 'report', collection: 'Operations' } },
  { id: 'd-sales-acct', template: 't-acct360', name: 'Sales — Account 360', description: 'Full account health view for sales reps: pipeline, contacts, and engagement signals.', entity: 'Company', audience: 'Sales Agent', owner: 'Priya Nair', status: 'published', widgets: 8, updated: '2 days ago', placement: { surface: 'profile', profileType: 'Company', scope: 'all', entityId: null, entityName: null, tab: 'Overview' } },
  { id: 'd-support-acct', template: 't-support', name: 'Support — Account Health', description: 'Support-specific health metrics pinned to Acme Corporation — tickets, SLA status, and CSAT.', entity: 'Company', audience: 'Support Agent', owner: 'Dana Lee', status: 'draft', widgets: 5, updated: '5 hours ago', placement: { surface: 'profile', profileType: 'Company', scope: 'entity', entityId: 'acme-001', entityName: 'Acme Corporation', tab: 'Activity' } },
  { id: 'd-mgr-overview', template: 't-exec', name: 'Manager Overview', description: 'High-level summary of team performance, quota attainment, and key operational KPIs.', entity: 'Report', audience: 'Manager', owner: 'Priya Nair', status: 'pending', widgets: 12, updated: '1 week ago', placement: { surface: 'report', collection: 'Executive' } },
  { id: 'd-rev-exec', template: 't-exec', name: 'Revenue Exec Report', description: 'Revenue metrics for Finance leadership: ARR, churn, pipeline momentum, and cash flow.', entity: 'Report', audience: 'Manager', owner: 'Robert Chen', status: 'published', widgets: 10, updated: '3 days ago', placement: { surface: 'report', collection: 'Finance Reports' } },
  { id: 'd-contact-360', template: 't-acct360', name: 'Contact 360', description: 'Unified profile for contacts — activity history, deal participation, and communication log.', entity: 'Contact', audience: 'Sales Agent', owner: 'Sam Ortiz', status: 'published', widgets: 7, updated: '1 day ago', placement: { surface: 'profile', profileType: 'Contact', scope: 'all', entityId: null, entityName: null, tab: 'Overview' } },
  { id: 'd-employee-perf', template: 't-exec', name: 'Employee Performance', description: 'Performance metrics and goal tracking for individual contributors across the org.', entity: 'Employee', audience: 'Manager', owner: 'Yuki Tanaka', status: 'draft', widgets: 6, updated: '4 hours ago', placement: { surface: 'profile', profileType: 'Employee', scope: 'all', entityId: null, entityName: null, tab: 'Performance' } },
  { id: 'd-cs-health', template: 't-support', name: 'CS Health', description: 'Account-level health scores for all company profiles — monitored by the CS team.', entity: 'Company', audience: 'Support Agent', owner: 'Aisha Khan', status: 'published', widgets: 9, updated: '6 days ago', placement: { surface: 'profile', profileType: 'Company', scope: 'all', entityId: null, entityName: null, tab: 'Activity' } },
  { id: 'd-team-home', template: 't-acct360', name: 'Sales Team Home', description: 'Personal home for Sales Agents — pipeline snapshot, open tasks, and daily priorities.', entity: 'Home', audience: 'Sales Agent', owner: 'Priya Nair', status: 'published', widgets: 5, updated: '2 weeks ago', placement: { surface: 'home', homeScope: 'team' } },
  { id: 'd-workspace-home', template: 't-workspace-home', name: 'Workspace Home', description: 'Default personal home with cross-workspace signals, recent activity, and upcoming actions.', entity: 'Home', audience: { type: 'global' }, owner: 'AIMS OS', status: 'published', widgets: 3, updated: 'just now', placement: { surface: 'home', homeScope: 'personal' } },
  { id: 'd-ai-consumption', template: 't-ai-consumption', name: 'AI Consumption', description: 'Usage analytics for AIMS AI features — agent runs, token spend, and automation volume.', entity: 'Report', audience: { type: 'global' }, owner: 'AIMS OS', status: 'published', widgets: 5, updated: 'just now', placement: { surface: 'report', collection: 'Executive' } },
  { id: 'd-tasca-watchdog', template: 't-tasca-watchdog', name: 'Financial Watchdog — Tasca', description: 'Automated anomaly detection on Tasca financial data — flagged transactions and variance alerts.', entity: 'Report', audience: { type: 'global' }, owner: 'AIMS OS', status: 'published', widgets: 6, updated: 'just now', placement: { surface: 'report', collection: 'Executive' } },
  { id: 'd-deal-room', template: 't-acct360', name: 'Deal Room', description: 'All deal-level data in one view: stage progression, stakeholders, documents, and next steps.', entity: 'Deal', audience: 'Sales Agent', owner: 'Liam Murphy', status: 'draft', widgets: 4, updated: '3 hours ago', placement: { surface: 'profile', profileType: 'Deal', scope: 'all', entityId: null, entityName: null, tab: 'Overview' } },
  { id: 'd-marketing', template: 't-exec', name: 'Marketing Performance', description: 'Campaign ROI, lead generation volume, and multi-touch attribution metrics for marketing.', entity: 'Report', audience: 'Manager', owner: 'Elena Petrova', status: 'published', widgets: 11, updated: '5 days ago', placement: { surface: 'report', collection: 'Sales Reports' } },
  { id: 'd-support-mgr', template: 't-support', name: 'Support Leadership', description: 'Aggregate support metrics for leadership: team load, SLA adherence, and CSAT trend.', entity: 'Report', audience: 'Manager', owner: 'James Okonkwo', status: 'pending', widgets: 8, updated: '1 week ago', placement: { surface: 'report', collection: 'Support Reports' } },
  { id: 'd-finance', template: 't-support', name: 'Finance Close', description: 'Month-end close checklist with P&L variance, reconciliation status, and pending approvals.', entity: 'Report', audience: 'Manager', owner: 'Priya Nair', status: 'draft', widgets: 9, updated: '2 days ago', placement: { surface: 'report', collection: 'Finance Reports' } },
  { id: 'd-onboarding', template: 't-acct360', name: 'New Hire Onboarding', description: 'Onboarding progress tracker for new employees — milestones, tasks, and manager check-ins.', entity: 'Employee', audience: 'All audiences', owner: 'Yuki Tanaka', status: 'published', widgets: 5, updated: '1 month ago', placement: { surface: 'profile', profileType: 'Employee', scope: 'all', entityId: null, entityName: null, tab: 'Overview' } },
  { id: 'd-exec-home', template: 't-exec', name: 'Exec Home', description: 'Executive personal home with cross-functional KPIs, active alerts, and board-level priorities.', entity: 'Home', audience: 'Manager', owner: 'You (admin)', status: 'published', widgets: 7, updated: '3 days ago', placement: { surface: 'home', homeScope: 'personal' } },
]
...
// eventType: completion | failure | approval | assignment | escalation | reminder | security | update
// severity: info | success | warning | critical
// day: today | yesterday | earlier
export const NOTIFICATION_CATEGORIES = [
  { id: 'human',       label: 'Human approvals & assignments', mandatory: true  },
  { id: 'agent',       label: 'Agent activity',                mandatory: false },
  { id: 'workflow',    label: 'Workflow updates',              mandatory: false },
  { id: 'integration', label: 'Integration alerts',            mandatory: false },
  { id: 'system',      label: 'System notifications',          mandatory: true  },
]
export const notifications = [
  // HTL -- Human-in-the-Loop handoffs requiring a decision
  {
    id: 'n1', source: 'human', eventType: 'approval', severity: 'warning',
    title: 'Approval required -- role change for Maria Gonzalez',
    desc: 'People Sync Agent flagged a compensation band exception. Sign-off required before Friday\'s payroll cycle.',
    time: '4m ago', day: 'today', unread: true, assignedToMe: true,
    ctas: ['Approve', 'Reject'],
  },
  {
    id: 'n8', source: 'human', eventType: 'reminder', severity: 'warning',
    title: 'Escalation: org chart conflict -- Maria Gonzalez',
    desc: 'Two agents disagree on the reporting line. Current record shows Manager: David Kim; HR Agent proposed Alicia Moore. Human resolution required.',
    time: '31m ago', day: 'today', unread: true, assignedToMe: true,
    ctas: ['Resolve', 'Delegate'],
  },
  // Agentic Studio -- agent runs on this entity
  {
    id: 'n2', source: 'agent', eventType: 'completion', severity: 'success',
    title: 'Employee enrichment completed -- Maria Gonzalez',
    desc: 'Contact Enrichment Agent updated 4 fields: LinkedIn URL, direct phone, start date confirmed, location verified.',
    time: '18m ago', day: 'today', unread: true,
    ctas: ['View diff'],
  },
  {
    id: 'n10', source: 'agent', eventType: 'failure', severity: 'critical',
    title: 'People Sync Agent blocked -- permission denied',
    desc: 'Agent tried to modify this record but was blocked by the PII Write governance policy. Human approval is required before any write can proceed.',
    time: '1h ago', day: 'today', unread: true,
    ctas: ['View trace', 'Grant access'],
  },
  // Governance Studio -- policy flags and compliance events
  {
    id: 'n3', source: 'system', eventType: 'update', severity: 'critical',
    title: 'PII access review triggered -- Maria Gonzalez',
    desc: '3 agents accessed this record in the last 7 days. Your org data handling policy requires a quarterly access review.',
    time: '2h ago', day: 'today', unread: true,
    ctas: ['Start review'],
  },
  {
    id: 'n12', source: 'system', eventType: 'update', severity: 'info',
    title: 'Quarterly compliance audit passed -- People Ops',
    desc: 'Maria Gonzalez\'s record passed all 12 compliance checks. Next audit scheduled for Nov 1.',
    time: '4h ago', day: 'today', unread: false,
    ctas: [],
  },
  // HGS -- Human Governance Studio workflow events
  {
    id: 'n4', source: 'workflow', eventType: 'completion', severity: 'success',
    title: 'Onboarding workflow completed -- Maria Gonzalez',
    desc: 'All 7 onboarding steps finished. Record is fully active in People Ops -- Acme Corp.',
    time: 'Yesterday', day: 'yesterday', unread: false,
    ctas: ['View summary'],
  },
  {
    id: 'n9', source: 'workflow', eventType: 'update', severity: 'warning',
    title: '90-day performance review overdue -- Maria Gonzalez',
    desc: 'HGS scheduled review was not completed within the SLA window. Manager David Kim has been notified.',
    time: 'Yesterday', day: 'yesterday', unread: true, assignedToMe: true,
    ctas: ['Schedule review', 'Dismiss'],
  },
  // More HTL and Agentic items from earlier days
  {
    id: 'n5', source: 'human', eventType: 'assignment', severity: 'info',
    title: 'Assigned to you: offboarding checklist sign-off',
    desc: 'Priya Nair assigned the People Ops offboarding checklist for Acme Corp Q3. Due by end of week.',
    time: 'Yesterday', day: 'yesterday', unread: false, assignedToMe: true,
    ctas: ['Open task'],
  },
  {
    id: 'n6', source: 'agent', eventType: 'completion', severity: 'success',
    title: '8 employee records auto-enriched overnight',
    desc: 'Batch enrichment completed for People Ops -- Acme Corp. Maria Gonzalez and 7 others updated.',
    time: 'Yesterday', day: 'yesterday', unread: false,
    ctas: ['View report'],
  },
  {
    id: 'n7', source: 'system', eventType: 'security', severity: 'warning',
    title: 'Data retention flag -- People Ops Acme Corp',
    desc: '14 employee records are approaching the 3-year retention limit. Review required before auto-archival.',
    time: '2 days ago', day: 'earlier', unread: false,
    ctas: ['Review records'],
  },
  {
    id: 'n11', source: 'workflow', eventType: 'completion', severity: 'info',
    title: 'HGS: background check approved -- Acme Corp hire batch',
    desc: '6 of 6 candidates cleared. Records promoted from Candidate to Employee status.',
    time: '3 days ago', day: 'earlier', unread: false,
    ctas: [],
  },
  {
    id: 'n13', source: 'human', eventType: 'assignment', severity: 'info',
    title: 'HTL session resolved -- Acme Corp payroll dispute',
    desc: 'James Ortega closed the handoff after reconciling the payroll discrepancy for People Ops.',
    time: '4 days ago', day: 'earlier', unread: false,
    ctas: [],
  },
  {
    id: 'n14', source: 'agent', eventType: 'failure', severity: 'warning',
    title: 'Salary benchmarking agent -- stale data warning',
    desc: 'Benchmark data for People Ops roles is 45 days old. Agent paused until source is refreshed.',
    time: '5 days ago', day: 'earlier', unread: false,
    ctas: ['Refresh source'],
  },
  {
    id: 'n15', source: 'system', eventType: 'completion', severity: 'success',
    title: 'Governance policy updated: PII Write controls',
    desc: 'New policy PII Write -- Requires Human Approval is now active for all employee records in People Ops.',
    time: '6 days ago', day: 'earlier', unread: false,
    ctas: ['View policy'],
  },
]
