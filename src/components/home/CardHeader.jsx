  ...
  return (
    <div className="flex items-center justify-between px-5 pt-5 pb-3.5">
      <div className="flex items-center gap-2.5">
        <span className="text-gray-300 dark:text-slate-400">{icon}</span>
      ...
      {action && (
        <button
          ...
          className="text-[11px] font-medium text-gray-300 transition-colors hover:text-gray-600 dark:text-slate-400 dark:hover:text-slate-400"
        >
          {action.label}
        </button>
      )}
